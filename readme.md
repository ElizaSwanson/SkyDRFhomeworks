...
```
   ...
   python manage.py loaddata course_fixture.json --format json
   python manage.py loaddata lesson_fixture.json --format json
   python manage.py loaddata payment_fixture.json --format json
```
